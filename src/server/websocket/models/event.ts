...
type WSEventEmittingType =  'JANUS_CONFIG' | 'APERTURE_CONFIG' | 'ROOM_DESTROY' | 'MESSAGE_CREATE' | 'MESSAGE_DESTROY' | 'TYPING_UPDATE' | 'INVITE_UPDATE' | 'USER_JOIN' | 'USER_UPDATE' | 'USER_LEAVE' | 'OWNER_UPDATE' | 'CONTROLLER_UPDATE' | 'PORTAL_QUEUE_UPDATE'
